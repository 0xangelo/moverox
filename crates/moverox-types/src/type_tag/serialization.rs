...
impl SerializedTypeTagVariant {
    const fn new(variant: u32) -> Result<Self, u32> {
        Ok(match variant {
            0 => Self::Bool,
            1 => Self::U8,
            2 => Self::U64,
...
impl Serialize for TypeTag {
        ...
        S: Serializer,
    {
        if serializer.is_human_readable() {
            ...
            match self {
                Self::U8 => serializer.serialize_unit_variant(
                    "TypeTag",
                    SerializedTypeTagVariant::U8 as u32,
                    "u8",
                ),
                Self::U16 => serializer.serialize_unit_variant(
                    "TypeTag",
                    SerializedTypeTagVariant::U16 as u32,
                    "u16",
                ),
                Self::U32 => serializer.serialize_unit_variant(
                    "TypeTag",
                    SerializedTypeTagVariant::U32 as u32,
                    "u32",
                ),
                Self::U64 => serializer.serialize_unit_variant(
                    "TypeTag",
                    SerializedTypeTagVariant::U64 as u32,
                    "u64",
                ),
                Self::U128 => serializer.serialize_unit_variant(
                    "TypeTag",
                    SerializedTypeTagVariant::U128 as u32,
                    "u128",
                ),
                Self::U256 => serializer.serialize_unit_variant(
                    "TypeTag",
                    SerializedTypeTagVariant::U256 as u32,
                    "u256",
                ),
                Self::Bool => serializer.serialize_unit_variant(
                    "TypeTag",
                    SerializedTypeTagVariant::Bool as u32,
                    "bool",
                ),
                Self::Address => serializer.serialize_unit_variant(
                    "TypeTag",
                    SerializedTypeTagVariant::Address as u32,
                    "address",
                ),
                Self::Signer => serializer.serialize_unit_variant(
                    "TypeTag",
                    SerializedTypeTagVariant::Signer as u32,
                    "signer",
                ),
                Self::Vector(v) => serializer.serialize_newtype_variant(
                    "TypeTag",
                    SerializedTypeTagVariant::Vector as u32,
                    "vector",
                    v,
                ),
                Self::Struct(s) => serializer.serialize_newtype_variant(
                    "TypeTag",
